...
INSERT INTO "user_roles" ("id", "roles") VALUES (1, 'user')
    ON CONFLICT DO NOTHING;
INSERT INTO "examiners" ("id", "mail", "password", "firstname", "lastname", "titles")
VALUES (2, 'user1@pbs.edu.pl', '$2a$10$7b.9iLgXFVh.r1u9HEbMv.EDL3JcJgldsWHUg4etSUh4wCNGuExye', 'User', 'User', 'mgr inż.')
ON CONFLICT DO NOTHING;
...
VALUES (1, 'Jan', 'Kowalski', '222222')
    ON CONFLICT DO NOTHING;
INSERT INTO "reports" ("id", "student_id", "examiner_id", "classname", "examdate", "finalgrade")
VALUES (0, 0, 1, 'Mikroprocesory', NOW(), 4)
    ON CONFLICT DO NOTHING;
INSERT INTO "reports" ("id", "student_id", "examiner_id", "classname", "examdate", "finalgrade")
VALUES (1, 1, 1, 'Przetwarzanie obrazów', NOW(), 4)
    ON CONFLICT DO NOTHING;
INSERT INTO "reports" ("id", "student_id", "examiner_id", "classname", "examdate", "finalgrade")
VALUES (2, 1, 2, 'Przetwarzanie obrazów', NOW(), 4)
ON CONFLICT DO NOTHING;
...
VALUES (1, 'Drugie Pytanie?', 4)
    ON CONFLICT DO NOTHING;
INSERT INTO "questions" ("reportid", "question", "questionscore")
VALUES (2, 'Pytanie', 3.5)
ON CONFLICT DO NOTHING;
INSERT INTO "questions" ("reportid", "question", "questionscore")
VALUES (2, 'Drugie Pytanie?', 4)
ON CONFLICT DO NOTHING;